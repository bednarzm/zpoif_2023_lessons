...
public class JachtOdkrytopokladowy extends JachtZaglowy {
	...
	public boolean isPasyBalastowe() {
		return pasyBalastowe;
	}
	...
	public String toString() {
		return "JachtOdkrytopokladowy [pasyBalastowe=" + pasyBalastowe + ", powierzchniaZagla=" + powierzchniaZagla
				+ ", typ=" + typ + ", nazwaProducenta=" + nazwaProducenta + ", dlugosc=" + dlugosc + ", masa=" + masa
				+ "]";
	}
