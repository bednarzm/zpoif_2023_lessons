...
public class JachtKabinowy extends JachtZaglowy {
	...
	public String toString() {
		return "JachtKabinowy [zanurzenie=" + zanurzenie + ", komentarz=" + komentarz + ", powierzchniaZagla="
				+ powierzchniaZagla + ", typ=" + typ + ", nazwaProducenta=" + nazwaProducenta + ", dlugosc=" + dlugosc
				+ ", masa=" + masa + "]";
	}
